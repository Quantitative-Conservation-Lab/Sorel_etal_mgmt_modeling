...
dat_IPM$NOR_tier<-matrix(c(372,278,208,176,
                   350,259,176,80)*1.2,nrow=2)
dat_IPM$restoration_scalar<-matrix(1,4,3)
...
save(mod,file=here("results","ipm_fit_non_centered_5_02_hatch_scen.Rdata"))
...
load(here("results","stan_run_non_centered_hatch_4_12.Rdata"))
...
list_of_draws<-list_of_draws[seq(1,dim(list_of_draws)[1],by=45),]
